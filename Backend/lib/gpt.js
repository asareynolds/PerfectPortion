...
const getRecommendations = async function(imageID, age, weight, gender) {
    ...
    var prompt = `This is a meal for a ${age}-year-old ${gender} who weighs ${weight} lbs: ${foodStrings}. Evaluate this meal from a nutritional perspective. Do not mention the prompt in the answer, simply give a succinct response, 1 to 2 sentences per point, discussing: 1. Nutritional Value 2. Recommendations for a better meal, including specific foods, or no recommendation if the meal is sufficient.`;
